...
function startConversation() {
    fetch('https://chatbot-for-future-generation-early-learning-centres.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-future-generation-early-learning-centres.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbzCQXngSOA7zFa-blic2GMPE0B5tDK-bCPU5EqUTlQS8TRbvzEOXTu_Mdn_0or2wPm6tw/exec';
